...
legacy_header="'<section class=\"top\"><div class=\"top-left\"><div class=\"stats-title\">STATS</div><div class=\"sub\">YOUR TIN FOIL FA CUP CAMPAIGN</div><div class=\"red-star\">★</div><div class=\"minor\">STARTED WITH:</div><div class=\"club\">'+certEsc(origin.name)+'</div><div class=\"tiny-rule\"></div><div class=\"minor\">CURRENT CUSTODIAN:</div><div class=\"club\">'+certEsc(carrier.name)+'</div></div>'+"
legacy_call_sign_header="'<section class=\"top\"><div class=\"top-left\"><div class=\"stats-title\">STATS</div><div class=\"sub\">YOUR TIN FOIL FA CUP CAMPAIGN</div><div class=\"red-star\">★</div><div class=\"minor\">STARTED WITH:</div><div class=\"club\">'+certEsc(origin.name)+'</div><div class=\"tiny-rule\"></div><div class=\"minor\">CURRENT CUSTODIAN:</div><div class=\"club\">'+certEsc(carrier.name)+'</div>'+(campaignCallSign?'<div class=\"tiny-rule\"></div><div class=\"minor\">PIGEON CALL SIGN:</div><div class=\"call-sign\">'+certEsc(campaignCallSign)+'</div>':'')+'</div>'+"
unified_header="'<section class=\"top\"><div class=\"top-left\"><div class=\"stats-title\">STATS</div><div class=\"sub\">YOUR TIN FOIL FA CUP CAMPAIGN</div><div class=\"red-star\">★</div><div class=\"minor\">STARTED WITH:</div><div class=\"club\">'+certEsc(origin.name)+'</div><div class=\"tiny-rule\"></div><div class=\"minor\">CURRENT CUSTODIAN:</div><div class=\"club\">'+certEsc(carrier.name)+'</div>'+'</div>'+"
if legacy_call_sign_header in text: text=text.replace(legacy_call_sign_header,unified_header,1)
