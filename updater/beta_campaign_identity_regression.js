...
if(html.includes('.campaign-identity-band .campaign-identity-label:nth-of-type(3){display:block'))throw new Error('BETA iPhone Stats: obsolete forced label-only line break returned');
